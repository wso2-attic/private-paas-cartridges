...
(2) Generate template module `wso2esb-4.8.1-template-module-<PPAAS_VERSION>.zip` as described in [README.md] (https://github.com/wso2/product-private-paas/tree/master/cartridges/template-module/wso2esb-4.8.1) under "Creating ESB Template Module for Private PaaS" section.
